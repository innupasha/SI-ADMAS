...
@section('body')
    ...
    <div class="bg-red-700 flex items-center justify-center gap-5 sm:gap-20  p-10 text-center text-white relative">
        <img class="border-4 h-20 p-1 sm:h-60 -rotate-12 border-white border-dashed rounded-md" src="{{ asset('img/logopdam.png') }}" alt="tangspor-logo.png">
    ...
    <div class="bg-slate-300 py-3">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 grid-flow-row">
            <img src="{{ asset('img/sumsel.jpg') }}" alt="img_sponsors">
            <img src="{{ asset('img/pos.jpg') }}" alt="img_sponsors">
            <img src="{{ asset('img/bri.jpg') }}" alt="img_sponsors">
            <img src="{{ asset('img/indomaret.jpg') }}" alt="img_sponsors">
        </div>
    </div>
