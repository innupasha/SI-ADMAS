...
<div class="hero min-h-[400px] bg-slate-300 relative">
  ...
  <div class="hero-content text-center">
    <div class="max-w-md bg-white border border-black p-3 rounded-xl relative after:block after:h-full after:w-full after:bg-slate-200 after:-z-10 after:border after:top-4 after:border-black after:absolute after:rounded-xl">
            <h1 class="text-5xl font-bold bg-red-600 p-3 rounded-md text-white">Tentang Kami</h1>
              <p class="py-6" align="justify">Perumda Tirtaraja adalah Badan Usaha Milik Daerah (BUMD) yang bertanggung jawab atas penyediaan layanan air bersih di wilayah OGAN KOMERING ULU. Sebagai perusahaan yang beroperasi di sektor air minum, Perumda Tirtaraja memiliki komitmen untuk menyediakan akses air bersih yang berkualitas kepada masyarakat.</p>
          </div>
        </div>
      </div>
      ...
      <div class="hover:top-28 hover:-rotate-3 transition-all  bg-slate-400 w-80 rounded-xl p-5 border-2 shadow-lg shadow-slate-600 border-slate-800 overflow-hidden hidden lg:block relative sm:left-8 sm:top-32 sm:absolute">
        <div class="bg-white absolute top-0 w-full left-0 flex z-50">
          ...
          <p class="font-bold p-3"><span class="bg-slate-800 p-1 h-1 w-5 rounded-full"></span> Group Pelanggan Tirta Raja</p>
        </div>
        <div class="chat chat-start">
          <div class="chat-image avatar">
            <div class="w-10 rounded-full">
              <img src="<?php echo e(asset('/img/me.jpg')); ?>" />
            </div>
          </div>
          <div class="chat-header">
            Rajaswa
          </div>
          <div class="chat-bubble">Semoga dengan website ini pelanggan Tirta Raja menjadi lebih mudah untuk melapor!!!</div>
        </div>
  ...
  <div class="flex py-3 gap-3 bg-slate-200">
    ...
    <div class="sm:mt-10">
      ...
      <p class="text-md">Mempermudah pelanggan TIRTARAJA dalam melaporkan permasalahan.</p>
    </div>
  ...
  <div class="px-5 sm:px-0 py-16 flex flex-col sm:flex-row gap-7 sm:gap-20">
    <div class="sm:ml-5">
      ...
      <div class="mockup-code w-fit">
        <pre data-prefix="1"><code>Humas TIRTARAJA: 081311888098</code></pre> 
        <pre data-prefix="2"><code>PETUGAS  : 081311223344</code></pre> 
      </div>
    </div>
    ...
    <div class="hidden lg:block relative ml-auto w-96 h-40 border-4 border-r-0 border-slate-500 rounded-l-xl border-dashed">
      <img class="h-52 -mt-7 mx-auto rotate-12 border-4 border-dashed bg-white p-1 border-slate-500 rounded-md" src="<?php echo e(asset('/img/logo-tangspor.png')); ?>" alt="logo-tangspor.png">
    </div>
    ...
    <div>
        <div class="hero bg-gradient-to-b from-gray-100 to-slate-600">
            <div class="hero-content flex-col lg:flex-row text-white">
              <img src="<?php echo e(asset('img/me.jpg')); ?>" class="max-w-[350px] rounded-lg shadow-2xl" />
              <div>
                <h1 class="text-5xl font-bold">MAHASISWA INFORMATIKA UNIVERSITAS BATURAJA 2021</h1>
                <p class="py-6">IT Creator</p>
              </div>
            </div>
          </div>
    </div>
...
<?php echo $__env->make('layouts/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp4\htdocs\admas\resources\views/admas/tentang.blade.php ENDPATH**/ ?>