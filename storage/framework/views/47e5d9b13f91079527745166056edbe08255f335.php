...
?>
        ...
        <div class="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-3 sm:gap-7 w-full p-5">
            <?php $__currentLoopData = $terbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card card-compact w-full bg-base-100 shadow-xl box-border border-black border hover:scale-110 hover:z-50 transition-transform overflow-hidden">
                    <figure class="bg-gray-300"><img class="h-[150px] sm:h-[150px] w-full object-contain" src="<?php echo e(asset('img_pengaduan/' . $i->foto)); ?>" alt="img_pengaduan" /></figure>
                    <div class="p-3">
...
<?php echo $__env->make('layouts/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp4\htdocs\admas\resources\views/admas/pengaduan.blade.php ENDPATH**/ ?>