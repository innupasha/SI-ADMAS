...
<head>
    <link rel="shortcut icon" href="<?php echo e(asset('img/logopdam.png')); ?>" type="image/x-icon">
    ...
    <div class="drawer h-full">
        ...
        <div class="drawer-side">
          ...
          <ul class="menu h-full overflow-x-auto fixed p-4 bg-slate-900 text-white">
              <label for="my-drawer" class="text-4xl font-bold text-center mb-3 bg-red-700 p-3 rounded-md"><img class="inline-block -mt-2 h-10 border-2 border-white rounded" src="<?php echo e(asset('img/logopdam.png')); ?>" alt="logopdam.png"> TIRTARAJA!</label>
