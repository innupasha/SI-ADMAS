<?php $__env->startSection('body'); ?>
    ...
    <div class="bg-red-700 flex items-center justify-center gap-5 sm:gap-20  p-10 text-center text-white relative">
        <img class="border-4 h-20 p-1 sm:h-60 -rotate-12 border-white border-dashed rounded-md" src="<?php echo e(asset('img/logo-tangspor.png')); ?>" alt="tangspor-logo.png">
    ...
    <div class="bg-slate-300 py-3">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 grid-flow-row">
            <img src="<?php echo e(asset('img/sponsor.jpeg')); ?>" alt="img_sponsors">
            <img src="<?php echo e(asset('img/sponsor (2).jpeg')); ?>" alt="img_sponsors">
            <img src="<?php echo e(asset('img/sponsor (3).jpeg')); ?>" alt="img_sponsors">
            <img src="<?php echo e(asset('img/sponsor (4).jpg')); ?>" alt="img_sponsors">
        </div>
    </div>
